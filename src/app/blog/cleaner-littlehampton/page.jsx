...
export const metadata = {
  title: 'Cleaner Littlehampton | FindTrustedCleaners.com',
  description: 'A broad placeholder page targeting cleaner Littlehampton and related local search terms.',
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cleaner Littlehampton</h1>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200">
          A broad placeholder page targeting cleaner Littlehampton and related local search terms. This page has been added as a safe SEO placeholder so the URL exists, can be linked internally, and can be expanded into a full landing page later.
        </p>
        ...
        <div className="mt-8 rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl backdrop-blur">
          ...
          <p className="mt-3 text-slate-200">Primary phrase: <strong>cleaner Littlehampton</strong></p>
