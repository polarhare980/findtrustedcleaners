...
export const metadata = {
  title: 'Window Cleaning Littlehampton | FindTrustedCleaners.com',
  description: 'Find local window cleaners in Littlehampton. Placeholder page ready for full SEO copy and cleaner listings.',
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Window Cleaning Littlehampton</h1>

        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-200">
          Find local window cleaners in Littlehampton. Placeholder page ready for full SEO copy and cleaner listings. This page has been added as a safe SEO placeholder so the URL exists, can be linked internally, and can be expanded into a full landing page later.
        </p>
        ...
        <div className="mt-8 rounded-3xl border border-white/10 bg-white/10 p-6 shadow-2xl backdrop-blur">
          ...
          <p className="mt-3 text-slate-200">Primary phrase: <strong>window cleaner Littlehampton</strong></p>
